...
<div class="sidebar">
    ...
    <div class="grid text-center">
        ...
        <form action="mailto:someone@example.com" method="post" enctype="text/plain">
            ...
            <h5 for="name">Enter your name:</h5><br>
            <input type="text" name="name" required><br><br>
            <h5 for="id">Enter your id:</h5><br>
            <input type="text" name="id" required><br><br>
            <h5 for="desc">Enter your query:</h5><br>
            <textarea name="desc" id="desc" cols="30" rows="10" placeholder="Description" required></textarea><br><br>
