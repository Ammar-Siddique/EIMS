...
if(!$con)
{
    ...
    if(isset($_POST["save"]))
    {
        ...
        $query="select * from eims.student_info where roll_no='$username' and password='$password';";
        ...
        if (mysqli_num_rows($result)>0) 
        {
            while ($row=mysqli_fetch_array($result)) 
            {
                ...
                header('Location:../student/student.php');//insert destination here
            }
        }
        else
        { 
...
<html lang="en">
	<head>
		<title>Student Login - EIMS</title>
	...
	<body class="login-background">
        ...
        <div class="login-div mt-3 rounded">
            ...
            <div class="login-padding">
                ...
                <form class="p-1" action="student-login.php" method="POST">
                    <div class="form-group">
                        <label><h6>Enter Your ID:</h6></label>
                        <input type="text" name="roll_no" placeholder="Enter User ID" class="form-control" required>
                    </div>
                    <div class="form-group">
